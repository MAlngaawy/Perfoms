...
const EncourageCertificate = forwardRef(
  ({ certificate, forPrint }: Props, ref) => {
    ...
    if (screenWidth < 1200 && !forPrint) {
      ...
      namePosition.x = screenWidth * 0.568;
      namePosition.y = screenWidth * 0.306818182;
      namePosition.fontSize = screenWidth * 0.045;
      namePosition.letterSpacing = screenWidth * 0.011363636;
      datePosition.x = screenWidth * 0.511363636;
      datePosition.y = screenWidth * 0.602272727;
