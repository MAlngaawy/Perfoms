  ...
  return (
    <Card withBorder shadow="sm" radius="md" style={{width:'50%'}} className='m-auto mt-10'>
      <Card.Section className='relative' mt="sm">
        <Image className='opacity-50 bg-black' src="https://images.unsplash.com/photo-1579263477001-7a703f1974e6?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=500&q=80" />
